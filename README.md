...
<<<<<<< HEAD
<<<<<<< HEAD
This version is fully API-driven and does **not use Firebase**.  
=======
...
=======
This version is fully API-driven and does **not use Firebase**.  
>>>>>>> 9967109 (Revise README for project details and features)
>>>>>>> d70b3a9 (Revise README for project details and features)
